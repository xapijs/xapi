...
(function() {
  ...
  Runner.prototype = {
    ...
    startGame: function() {
      ...
      // Emit start
      this.outerContainerEl.dispatchEvent(new Event("start"));
    },
    ...
    gameOver: function() {
      ...
      // Emit score
      this.outerContainerEl.dispatchEvent(new CustomEvent("score", {
        detail: this.distanceMeter.getActualDistance(this.distanceRan)
      }));
